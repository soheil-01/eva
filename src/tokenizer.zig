...
pub const Tokenizer = struct {
    ...
    pub const TokenType = enum { Number, String, SemiColon, OpenBrace, CloseBrace, OpenPran, ClosePran, AdditiveOperator, MultiplicativeOperator, RelationalOperator, EqualityOperator, Identifier, SimpleAssign, ComplexAssign, Let, Comma, If, Else, True, False, Null, LogicalAnd, LogicalOr, LogicalNot, While, Do, For, Def, Return, Dot, OpenBracket, CloseBracket };
