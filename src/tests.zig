...
test "Call Expression" {
    try testParserOutput("a(x = 1,y);", "{\"body\":[{\"ExpressionStatement\":{\"expression\":{\"CallExpression\":{\"callee\":{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"a\"}}},\"arguments\":[{\"AssignmentExpression\":{\"operator\":{\"type\":\"SimpleAssign\",\"value\":\"=\"},\"left\":{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"x\"}}},\"right\":{\"PrimaryExpression\":{\"Literal\":{\"NumericLiteral\":{\"value\":1}}}}}},{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"y\"}}}]}}}}]}");
    try testParserOutput("a(x)(y);", "{\"body\":[{\"ExpressionStatement\":{\"expression\":{\"CallExpression\":{\"callee\":{\"CallExpression\":{\"callee\":{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"a\"}}},\"arguments\":[{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"x\"}}}]}},\"arguments\":[{\"PrimaryExpression\":{\"Identifier\":{\"name\":\"y\"}}}]}}}}]}");
}
